...
namespace JobsCatalog.Persistance.Migrations
{
    ...
    [Migration("20220403142924_AddedVersionStampToAudit")]
    partial class AddedVersionStampToAudit
    {
            ...
            modelBuilder.Entity("JobsCatalog.Domain.Entities.Company", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Created = new DateTimeOffset(new DateTime(2022, 4, 3, 14, 29, 23, 802, DateTimeKind.Unspecified).AddTicks(6728), new TimeSpan(0, 0, 0, 0, 0)),
                            CreatedBy = "Admin",
                            Inactivated = new DateTimeOffset(new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)),
                            Modified = new DateTimeOffset(new DateTime(2022, 4, 3, 14, 29, 23, 802, DateTimeKind.Unspecified).AddTicks(6728), new TimeSpan(0, 0, 0, 0, 0)),
                            ModifiedBy = "Admin",
            ...
            modelBuilder.Entity("JobsCatalog.Domain.Entities.JobDescription", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Created = new DateTimeOffset(new DateTime(2022, 4, 3, 14, 29, 23, 805, DateTimeKind.Unspecified).AddTicks(1575), new TimeSpan(0, 0, 0, 0, 0)),
                            CreatedBy = "Admin",
                            ...
                            Inactivated = new DateTimeOffset(new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)),
                            JobOfferId = 1,
                            Modified = new DateTimeOffset(new DateTime(2022, 4, 3, 14, 29, 23, 805, DateTimeKind.Unspecified).AddTicks(1575), new TimeSpan(0, 0, 0, 0, 0)),
                            ModifiedBy = "Admin",
            ...
            modelBuilder.Entity("JobsCatalog.Domain.Entities.JobOffer", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            City = "Wroclaw",
                            CompanyId = 1,
                            Created = new DateTimeOffset(new DateTime(2022, 4, 3, 14, 29, 23, 803, DateTimeKind.Unspecified).AddTicks(9699), new TimeSpan(0, 0, 0, 0, 0)),
                            CreatedBy = "Admin",
                            ExperienceLevelId = 1,
                            Inactivated = new DateTimeOffset(new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)),
                            Modified = new DateTimeOffset(new DateTime(2022, 4, 3, 14, 29, 23, 803, DateTimeKind.Unspecified).AddTicks(9699), new TimeSpan(0, 0, 0, 0, 0)),
                            ModifiedBy = "Admin",
