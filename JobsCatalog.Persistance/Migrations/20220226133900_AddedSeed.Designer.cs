            ...
            modelBuilder.Entity("JobsCatalog.Domain.Entities.Company", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Created = new DateTimeOffset(new DateTime(2022, 2, 26, 13, 38, 59, 924, DateTimeKind.Unspecified).AddTicks(1747), new TimeSpan(0, 0, 0, 0, 0)),
                            CreatedBy = "Admin",
                            Inactivated = new DateTimeOffset(new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)),
                            Modified = new DateTimeOffset(new DateTime(2022, 2, 26, 13, 38, 59, 924, DateTimeKind.Unspecified).AddTicks(1747), new TimeSpan(0, 0, 0, 0, 0)),
                            ModifiedBy = "Admin",
            ...
            modelBuilder.Entity("JobsCatalog.Domain.Entities.JobDescription", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Created = new DateTimeOffset(new DateTime(2022, 2, 26, 13, 38, 59, 926, DateTimeKind.Unspecified).AddTicks(7194), new TimeSpan(0, 0, 0, 0, 0)),
                            CreatedBy = "Admin",
                            ...
                            Inactivated = new DateTimeOffset(new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)),
                            JobOfferId = 1,
                            Modified = new DateTimeOffset(new DateTime(2022, 2, 26, 13, 38, 59, 926, DateTimeKind.Unspecified).AddTicks(7194), new TimeSpan(0, 0, 0, 0, 0)),
                            ModifiedBy = "Admin",
            ...
            modelBuilder.Entity("JobsCatalog.Domain.Entities.JobOffer", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            City = "Wroclaw",
                            CompanyId = 1,
                            Created = new DateTimeOffset(new DateTime(2022, 2, 26, 13, 38, 59, 925, DateTimeKind.Unspecified).AddTicks(5113), new TimeSpan(0, 0, 0, 0, 0)),
                            CreatedBy = "Admin",
                            ExperienceLevelId = 1,
                            Inactivated = new DateTimeOffset(new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)),
                            Modified = new DateTimeOffset(new DateTime(2022, 2, 26, 13, 38, 59, 925, DateTimeKind.Unspecified).AddTicks(5113), new TimeSpan(0, 0, 0, 0, 0)),
                            ModifiedBy = "Admin",
