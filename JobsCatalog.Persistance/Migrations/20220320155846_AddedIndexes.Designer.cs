...
namespace JobsCatalog.Persistance.Migrations
{
    ...
    [Migration("20220320155846_AddedIndexes")]
            ...
            modelBuilder.Entity("JobsCatalog.Domain.Entities.Company", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Created = new DateTimeOffset(new DateTime(2022, 3, 20, 15, 58, 45, 635, DateTimeKind.Unspecified).AddTicks(9300), new TimeSpan(0, 0, 0, 0, 0)),
                            CreatedBy = "Admin",
                            Inactivated = new DateTimeOffset(new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)),
                            Modified = new DateTimeOffset(new DateTime(2022, 3, 20, 15, 58, 45, 635, DateTimeKind.Unspecified).AddTicks(9300), new TimeSpan(0, 0, 0, 0, 0)),
                            ModifiedBy = "Admin",
            ...
            modelBuilder.Entity("JobsCatalog.Domain.Entities.JobDescription", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Created = new DateTimeOffset(new DateTime(2022, 3, 20, 15, 58, 45, 638, DateTimeKind.Unspecified).AddTicks(4352), new TimeSpan(0, 0, 0, 0, 0)),
                            CreatedBy = "Admin",
                            ...
                            Inactivated = new DateTimeOffset(new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)),
                            JobOfferId = 1,
                            Modified = new DateTimeOffset(new DateTime(2022, 3, 20, 15, 58, 45, 638, DateTimeKind.Unspecified).AddTicks(4352), new TimeSpan(0, 0, 0, 0, 0)),
                            ModifiedBy = "Admin",
            ...
            modelBuilder.Entity("JobsCatalog.Domain.Entities.JobOffer", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            City = "Wroclaw",
                            CompanyId = 1,
                            Created = new DateTimeOffset(new DateTime(2022, 3, 20, 15, 58, 45, 637, DateTimeKind.Unspecified).AddTicks(2446), new TimeSpan(0, 0, 0, 0, 0)),
                            CreatedBy = "Admin",
                            ExperienceLevelId = 1,
                            Inactivated = new DateTimeOffset(new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)),
                            Modified = new DateTimeOffset(new DateTime(2022, 3, 20, 15, 58, 45, 637, DateTimeKind.Unspecified).AddTicks(2446), new TimeSpan(0, 0, 0, 0, 0)),
                            ModifiedBy = "Admin",
