...
namespace JobsCatalog.Persistance.Migrations
{
    ...
    [Migration("20220404190304_AddedIndexToCompany")]
    partial class AddedIndexToCompany
    {
            ...
            modelBuilder.Entity("JobsCatalog.Domain.Entities.Company", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Created = new DateTimeOffset(new DateTime(2022, 4, 4, 19, 3, 4, 73, DateTimeKind.Unspecified).AddTicks(9960), new TimeSpan(0, 0, 0, 0, 0)),
                            CreatedBy = "Admin",
                            Inactivated = new DateTimeOffset(new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)),
                            Modified = new DateTimeOffset(new DateTime(2022, 4, 4, 19, 3, 4, 73, DateTimeKind.Unspecified).AddTicks(9960), new TimeSpan(0, 0, 0, 0, 0)),
                            ModifiedBy = "Admin",
            ...
            modelBuilder.Entity("JobsCatalog.Domain.Entities.JobDescription", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Created = new DateTimeOffset(new DateTime(2022, 4, 4, 19, 3, 4, 76, DateTimeKind.Unspecified).AddTicks(5262), new TimeSpan(0, 0, 0, 0, 0)),
                            CreatedBy = "Admin",
                            ...
                            Inactivated = new DateTimeOffset(new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)),
                            JobOfferId = 1,
                            Modified = new DateTimeOffset(new DateTime(2022, 4, 4, 19, 3, 4, 76, DateTimeKind.Unspecified).AddTicks(5262), new TimeSpan(0, 0, 0, 0, 0)),
                            ModifiedBy = "Admin",
            ...
            modelBuilder.Entity("JobsCatalog.Domain.Entities.JobOffer", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            City = "Wroclaw",
                            CompanyId = 1,
                            Created = new DateTimeOffset(new DateTime(2022, 4, 4, 19, 3, 4, 75, DateTimeKind.Unspecified).AddTicks(3243), new TimeSpan(0, 0, 0, 0, 0)),
                            CreatedBy = "Admin",
                            ExperienceLevelId = 1,
                            Inactivated = new DateTimeOffset(new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)),
                            Modified = new DateTimeOffset(new DateTime(2022, 4, 4, 19, 3, 4, 75, DateTimeKind.Unspecified).AddTicks(3243), new TimeSpan(0, 0, 0, 0, 0)),
                            ModifiedBy = "Admin",
